...
from data3 import loadData

class Data:
    def __init__(self, max_features=70000, maxlen=5):
...
class RNN_LSTM(models.Model):
    def __init__(self, max_features, maxlen):
        ...
        h = layers.Embedding(max_features, 256)(x)
        h = layers.LSTM(256, dropout=0.2, recurrent_dropout=0.2)(h)
        y = layers.Dense(1, activation='step')(h)
        super().__init__(x, y)
...
class Machine:
    def __init__(self,max_features=2500,maxlen=5):
