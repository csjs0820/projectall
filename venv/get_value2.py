...
ax = plt.subplot(321,xlim=(0, 50), ylim=(650, 900)) #엄지 그래프 x축 범위 0 ~ 50, y축 범위 100 ~ 400
ax2 = plt.subplot(322,xlim=(0, 50), ylim=(650, 900)) #검지 그래프
ax3 = plt.subplot(323,xlim=(0, 50), ylim=(650, 900)) #중지 그래프
ax4 = plt.subplot(324,xlim=(0, 50), ylim=(650, 900)) #약지 그래프
ax5 = plt.subplot(325,xlim=(0, 50), ylim=(650, 900)) #새끼 그래프
